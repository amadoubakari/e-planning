...
public class LocalData {
    ...
    public void setTitle(String titleMsg) {
        prefsEditor.putString(title, titleMsg);
        prefsEditor.commit();
    }

    public String getDescription() {
        return appSharedPrefs.getString(description, "");
    }

    public void setDescription(String descriptionMsg) {
        prefsEditor.putString(description, descriptionMsg);
        prefsEditor.commit();
    }
